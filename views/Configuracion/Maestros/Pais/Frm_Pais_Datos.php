...
<!-- INGRESAMOS EL CODIGO DE NUSTRO CONTENEDOR -->
	...
	<div class="Menu-add d-flex flex-row-reverse bd-highlight">		
		<a href="index.php?c=configuracion&a=CrudPais&id=0" class="btn btn-success"><i class="fas fa-plus"></i></a>
			...
			<div class="table-responsive">
				<table id="example" class="table table-striped table-bordered AllDataTable" style="width:100%">
					...
					<tbody>
						...
						?>
							<tr>
								<td class="text-center"><?=$row['pa_id'];?></td>
								<td class="text-center"><?=$row['pa_nombre'];?></td>								
								<td class="text-center table-acciones">
									<a href="index.php?c=configuracion&a=crud2Pais&id=<?=$row['pa_id'];?>&Funcion=1" class="btn btn-info">
										<i class="fas fa-user-edit"></i>
									</a>
									<a href="index.php?c=configuracion&a=crud2Pais&id=<?=$row['pa_id'];?>&Funcion=2" class="btn btn-danger">
