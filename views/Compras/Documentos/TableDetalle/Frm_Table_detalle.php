					...
					<div class="responsive">						
						<table class="table table-sm">
							...
							<tbody>
								...
								?>
									<tr>
										<td class="text-center"><?=$row['detfac_com_id'];?></td>
										<td class="text-center"><?=$row['detfac_pro_codigo'];?></td>                                        
										<td class="text-center"><?=$row['detfac_pro_descrip2'];?></td>
...
$(document).ready(function(){
		$('#SaveTras').click(function(){
			...
			if (formapag=='0') {
				...
				$.ajax({
					url:'index.php?c=compras&a=InsertCompras',
