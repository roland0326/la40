...
$nrodcto=$funciones->NrodctoVenta();

require_once 'views/Ventas/Documentos/Modal/Modal_poppup.php';
?>
    <!-- INGRESAMOS EL CODIGO DE NUSTRO CONTENEDOR -->
	<ol class="breadcrumb miga-pan">
			<li class="breadcrumb-item ">
				  <a href="index.php?c=ventas&a=LoadDocVentas">Modulo Ventas</a>
			</li>
			<li class="breadcrumb-item active">Documentos</li>
			<li class="breadcrumb-item active">ventas</li>
	</ol>
	<div class="Menu-add d-flex justify-content-start">		
		<a href="index.php?c=ventas&a=LoadDocVentas" class="btn btn-success"><i class="fas fa-arrow-circle-left"></i></a>
	...
	<div class="container-fluid">
		<div class="container">		
					<div class="row">
						<div class="col-12">
							<h4 class="text-center">Creacion factura de venta</h4>
							<hr>
						</div>
						...
						<hr>
							<h4 class="text-center">Ingreso detalle de la venta</h4>
							
						</div>
						<div class="col-xl-6 col-md-6 col-sm-12">
								<div class="input-group">
									<div class="input-group-prepend">
										<label class="btn btn-color ModalCategoria"><strong>Producto:</strong></label>
									</div>
						...
						<div class="col-xl-6 col-md-6 col-sm-12">
								<div class="input-group">
									<div class="input-group-prepend">
										<label class="btn btn-color"><strong>Saldo.Inv:</strong></label>
									</div>
									<input type="text" class="form-control" name="TxtSaldo" id="TxtSaldo"  maxlength="25" readonly>
								</div>				
						</div>						
						<div class="col-xl-12 col-md-12 col-sm-12">
								<div class="input-group">
						...
						<div class="col-xl-4 col-md-4 col-sm-12 ">								
									<button class="btn btn-primary" id="LoadTempVenta"><i class="fas fa-file-download"></i></button>		
							</div>
